  ...
  PROTECTED SECTION.
    TYPES:
      BEGIN OF ts_location,
        building     TYPE zfsa_contact-building,
        country      TYPE zfsa_contact-country,
        street       TYPE zfsa_contact-street,
        city         TYPE zfsa_contact-city,
        postcode     TYPE zfsa_contact-postcode,
        addresslabel TYPE zfsa_contact-address_label,
      END OF ts_location,
      tt_location TYPE STANDARD TABLE OF ts_location WITH EMPTY KEY,

      BEGIN OF ts_region,
        region  TYPE zfsa_root_a-region,
        country TYPE zfsa_root_a-country,
      END OF ts_region,
    ...
    CLASS-METHODS:
      ...
      get_field_with_quantity
        RETURNING
          VALUE(rv_dec)             TYPE zfsa_root_a-field_with_quantity,
      get_price
        RETURNING
          VALUE(rv_dec)             TYPE zfsa_root_a-field_with_price,
      get_location
        RETURNING
      ...
      get_percent
        RETURNING
          VALUE(rv_percent)         TYPE zfsa_child_a-field_with_percent,
      get_boolean
        RETURNING
...
CLASS lcl_fsa_contact DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.
  ...
  PUBLIC SECTION.
    TYPES:
     tt_contact TYPE STANDARD TABLE OF zfsa_contact WITH KEY id.
    ...
    CLASS-METHODS:
      ...
      get
        RETURNING
          VALUE(rs_contact) TYPE zfsa_contact.
  PROTECTED SECTION.
  PRIVATE SECTION.
    CLASS-DATA:
...
CLASS lcl_fsa_criticality DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.
  ...
  PUBLIC SECTION.
    TYPES:
     tt_criticality TYPE STANDARD TABLE OF zfsa_critlty WITH KEY code.
    ...
    CLASS-METHODS:
      ...
      get
        RETURNING
          VALUE(rs_criticality) TYPE zfsa_critlty.
  PROTECTED SECTION.
  PRIVATE SECTION.
    CLASS-DATA:
...
CLASS lcl_fsa_navigation DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.
  ...
  PUBLIC SECTION.
    TYPES:
     tt_navigation TYPE STANDARD TABLE OF zfsa_nav WITH KEY id.
    ...
    CLASS-METHODS:
      ...
      get
        RETURNING
          VALUE(rs_navigation) TYPE zfsa_nav.
  PROTECTED SECTION.
  PRIVATE SECTION.
    CLASS-DATA:
...
CLASS lcl_fsa_root DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.
  ...
  PUBLIC SECTION.
    TYPES:
     tt_root TYPE STANDARD TABLE OF zfsa_root_a WITH KEY id.
...
CLASS lcl_fsa_chart DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.
  ...
  PUBLIC SECTION.
    TYPES:
     tt_chart TYPE STANDARD TABLE OF zfsa_chart_a WITH KEY id.
...
CLASS lcl_fsa_child DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.
  ...
  PUBLIC SECTION.
    TYPES:
     tt_child TYPE STANDARD TABLE OF zfsa_child_a WITH KEY id.
...
CLASS lcl_fsa_grandchild DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.
  ...
  PUBLIC SECTION.
    TYPES:
     tt_grandchild TYPE STANDARD TABLE OF zfsa_gch_a WITH KEY id.

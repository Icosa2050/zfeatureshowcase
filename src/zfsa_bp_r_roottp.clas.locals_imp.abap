CLASS lhc_Root DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    TYPES: tt_criticality TYPE STANDARD TABLE OF zfsa_critlty WITH DEFAULT KEY.
...
CLASS lhc_Root IMPLEMENTATION.
  ...
  METHOD changeCriticality.
    ...
    MODIFY ENTITIES OF zFSA_R_RootTP IN LOCAL MODE
      ENTITY Root
        UPDATE
    ...
    READ ENTITIES OF zFSA_R_RootTP IN LOCAL MODE
      ENTITY Root
